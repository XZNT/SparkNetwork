        ...
        $.post(api['posts/scraper'], { 'query': query }, function (response) {
          ...
          if (response.callback) {
            ...
            if (response.link['source_type'] == "photo") {
              ...
              /* media */
              if (response.link['source_provider'] == "YouTube" || response.link['source_provider'] == "Facebook" || response.link['source_provider'] == "Twitch" || response.link['source_provider'] == "Vimeo" || response.link['source_provider'] == "Rumble.com" || response.link['source_provider'] == "Banned.Video" || response.link['source_provider'] == "brighteon") {
