            ...
            <div class="col-12 col-sm-10">
              <div class="time clearfix">
                ...
                <div class="float-right">
                  ...
                  {else}
                    <button data-toggle="tooltip" data-placement="top" title='{__("Report")}' class="btn btn-sm btn-light btn-icon btn-rounded" data-toggle="modal" data-url="data/report.php?do=create&handle=forum_thread&id={$thread['thread_id']}">
                ...
                <div class="col-12 col-sm-10">
                  <div class="time clearfix">
                    ...
                    <div class="float-right">
                      ...
                      {else}
                        <button data-toggle="tooltip" data-placement="top" title='{__("Report")}' class="btn btn-sm btn-light btn-icon btn-rounded" data-toggle="modal" data-url="data/report.php?do=create&handle=forum_reply&id={$reply['reply_id']}">
                          <i class="fa fa-flag fa-fw"></i>
                        </button>
                      {/if}
                    </div>
