    ...
    <form class="js_ajax-forms" data-url="admin/emojis.php?do=add">
      <div class="card-body">
        <div class="alert alert-info">
          ...
          <div class="text pt5">
            {__("Sngine uses Twemoji Amazing and you can check")} <a class="alert-link" target="_blank" href="https://unicode.org/emoji/charts/emoji-list.html">{__("Emoji Cheat Sheet")}</a> {__("for the Emojis")}.<br>
            {__("You must replace spaces with hyphens, For example: grinning face became :grinning-face: for pattern and grinning-face for class")}.
          </div>
        </div>
