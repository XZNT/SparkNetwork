            ...
            <div class="form-group form-row">
              ...
              <div class="col-md-9">
                <select class="form-control selectpicker" name="privacy">
                  <option {if $data['event_privacy'] == "public"}selected{/if} value="public" data-content="<div class='option'><div class='icon'><i class='fa fa-globe fa-lg'></i></div><div class='text'><b>{__("Public Event")}</b><span class='d-none d-md-inline'><br>{__("Anyone can see the event, its users and posts")}.</span>
                                    </div></div>">{__("Public Event")}</option>
                  <option {if $data['event_privacy'] == "closed"}selected{/if} value="closed" data-content="<div class='option'><div class='icon'><i class='fa fa-unlock-alt fa-lg'></i></div><div class='text'><b>{__("Closed Event")}</b><span class='d-none d-md-inline'><br>{__("Only event users can see posts")}.</span>
                                    </div></div>">{__("Closed Event")}</option>
                  <option {if $data['event_privacy'] == "secret"}selected{/if} value="secret" data-content="<div class='option'><div class='icon'><i class='fa fa-lock fa-lg'></i></div><div class='text'><b>{__("Secret Event")}</b><span class='d-none d-md-inline'><br>{__("Only invited users and event users can find the event")}.</span>
